...
extension CurrencySelectionViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.detailTextLabel?.text = getCurrencyFullName(for: currency)
    ...
    /// Получает полное название валюты по ее коду
    private func getCurrencyFullName(for code: String) -> String {
